<x-layouts.admin :title="'Account'">
    ...
    <h1 class="font-display text-2xl font-semibold tracking-tight text-ink-950 dark:text-white">Account</h1>
    <p class="mt-1 text-sm text-ink-500 dark:text-ink-400">Update your own name/email/phone, or change your password.</p>
