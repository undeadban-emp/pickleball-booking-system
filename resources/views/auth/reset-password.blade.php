<x-layouts.app :title="'Reset Password — '.config('app.name')" :hide-footer="true">
    ...
    <section class="mx-auto flex max-w-lg flex-col justify-center px-4 py-10 sm:px-6">
        ...
        >
            ...
            <div class="flex flex-col gap-1.5">
                <label for="password" class="text-sm font-medium text-ink-800 dark:text-ink-200">New Password</label>
                <div class="relative">
                    <input
                        id="password"
