                ...
                <template x-if="!loading && !error && courts.length > 0">
                    <div>
                        ...
                        <div class="overflow-x-auto p-4">
                            <div class="min-w-140">
                                {{-- Court header row --}}
                                <div class="grid gap-3" :style="`grid-template-columns: repeat(${courts.length}, minmax(0,1fr))`">
                                    <template x-for="court in courts" :key="'h-' + court.id">
                                        <p class="text-center text-xs font-semibold tracking-wide text-ink-500 uppercase dark:text-ink-400" x-text="court.name"></p>
                                    </template>
                                </div>
